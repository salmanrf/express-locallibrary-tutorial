...
exports.author_detail = function(req, res, next) {
    async.parallel({
        author: (callback) => Author.findById(req.params.id, callback),
        author_books: (callback) => Book.find({'author': req.params.id},'title summary', callback)
...
exports.author_update_post = [
    ...
    (req, res, next) => {
        ...
        Author.findByIdAndUpdate(req.body.id, author, {}, (err, theauthor) => {
            if(err) return next(err);
